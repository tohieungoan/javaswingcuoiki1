...
public class ttgv extends JFrame implements ActionListener {
    ...
    public ttgv(){
        ...
        con.setBackground(new java.awt.Color(255, 255, 185));
         con.setLayout(null);
         title = new JLabel("Thong tin giao vien");
         ...
         con.add(title);
         con.add(anh);
         id = new JLabel("ID giao vien :"+idgv);
         id.setFont(font);
         id.setBounds(130, 80, 300, 100);
         ten = new JLabel("Ten giao vien :"+namegv);
         ten.setFont(font);
         ten.setBounds(130, 130, 300, 100);
         namsinh = new JLabel("Nam sinh giao vien :"+namsinhgv);
         namsinh.setFont(font);
         namsinh.setBounds(130, 180, 300, 100);
         chuc = new JLabel("Chu giao vien :"+chucvu);
         chuc.setFont(font);
         chuc.setBounds(130, 230, 300, 100);
         tk = new JLabel("Tai khoan giao vien :"+taikhoangv);
         tk.setFont(font);
         tk.setBounds(130, 280, 300, 100);
         mk = new JLabel("Mat khau giao vien :"+mkgv);
         mk.setFont(font);
         mk.setBounds(130, 330, 300, 100);
            ...
            undoo = new JButton("tro lai");
               ...
               timtiep = new JButton("tim gv khac");
               ...
               gv.setTitle("xem thong tin giao vien");
               gv.setSize(500, 600);
    ...
    if(ktra==0){
        gv.setVisible(false);
        setVisible(false);
        JOptionPane.showMessageDialog(rootPane, "khong tim duoc giao vien co id : "+ viewAdmin.tkgv ,"find error",
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        else  if(e.getActionCommand().equals("tim gv khac")){
            gv.dispose();
            new nhapidtk();
        }
    }
