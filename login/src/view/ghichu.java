...
import controller.*;
    public class ghichu extends JFrame implements ActionListener {
        ...
        public ghichu(){
            ...
            name.setFont(font);
            JLabel namsinh = new JLabel("nam sinh :"+namsinhhs);
            ...
            mon.setFont(font);
            luamon.setFont(font);
            String [] loi = new String [] {"Dung tai lieu","trao doi","vi pham khac","vang mat"}; 
            vipham = new JComboBox(loi);
            JLabel viphamlb = new JLabel("vi pham :");
            viphamlb.setFont(font);
            vipham.setFont(font);
            JLabel ghichuu = new JLabel("ghi chu ");
